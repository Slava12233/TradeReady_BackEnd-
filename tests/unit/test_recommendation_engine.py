...
def test_pair_disparity():
    ...
    results = {"avg_roi_pct": 5, "avg_win_rate": 0.6, "avg_max_drawdown_pct": 5,
               "avg_trades_per_episode": 10, "avg_sharpe": 1.0}
...
def test_low_win_rate():
    ...
    results = {"avg_roi_pct": 2, "avg_win_rate": 0.35, "avg_max_drawdown_pct": 5,
               "avg_trades_per_episode": 10, "avg_sharpe": 1.0}
...
def test_high_win_rate():
    ...
    results = {"avg_roi_pct": 8, "avg_win_rate": 0.85, "avg_max_drawdown_pct": 3,
               "avg_trades_per_episode": 5, "avg_sharpe": 1.5}
    recs = generate_recommendations(results, {}, BASE_DEFINITION)
...
def test_high_drawdown():
    ...
    results = {"avg_roi_pct": 5, "avg_win_rate": 0.6, "avg_max_drawdown_pct": 20,
               "avg_trades_per_episode": 10, "avg_sharpe": 1.0}
    recs = generate_recommendations(results, {}, BASE_DEFINITION)
...
def test_low_drawdown():
    ...
    results = {"avg_roi_pct": 2, "avg_win_rate": 0.6, "avg_max_drawdown_pct": 1.5,
               "avg_trades_per_episode": 10, "avg_sharpe": 1.0}
    recs = generate_recommendations(results, {}, BASE_DEFINITION)
...
def test_few_trades():
    ...
    results = {"avg_roi_pct": 2, "avg_win_rate": 0.6, "avg_max_drawdown_pct": 5,
               "avg_trades_per_episode": 1.5, "avg_sharpe": 1.0}
    recs = generate_recommendations(results, {}, BASE_DEFINITION)
...
def test_low_sharpe():
    ...
    results = {"avg_roi_pct": 2, "avg_win_rate": 0.6, "avg_max_drawdown_pct": 5,
               "avg_trades_per_episode": 10, "avg_sharpe": 0.3}
    recs = generate_recommendations(results, {}, BASE_DEFINITION)
...
def test_negative_roi():
    ...
    results = {"avg_roi_pct": -3, "avg_win_rate": 0.4, "avg_max_drawdown_pct": 10,
               "avg_trades_per_episode": 10, "avg_sharpe": -0.2}
    recs = generate_recommendations(results, {}, BASE_DEFINITION)
...
def test_no_recommendations_for_good_strategy():
    ...
    results = {"avg_roi_pct": 8, "avg_win_rate": 0.65, "avg_max_drawdown_pct": 5,
               "avg_trades_per_episode": 15, "avg_sharpe": 1.5}
