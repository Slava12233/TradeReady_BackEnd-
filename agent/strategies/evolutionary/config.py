...
_VALID_FITNESS_FNS: frozenset[str] = frozenset(
    [
        "sharpe_minus_drawdown",   # sharpe_ratio - 0.5 * max_drawdown_pct (default)
...
class EvolutionConfig(BaseSettings):
    ...
    fitness_fn: str = Field(
        ...
        description=(
            ...
            "Must be one of: ``sharpe_minus_drawdown`` (Sharpe - 0.5 × drawdown), "
    ...
    def historical_window(self) -> tuple[str, str]:
        """Return the historical battle window as ISO-8601 UTC strings.
